...
// *************************Assignment_No_02_Chapter 2 to 4**************************
...
// var email = " m.zeeshan342@gmail.com";
// alert (myEmail + email);
...
// *************************Assignment_No_03_Chapter 5 and 6 to 9**************************
...
// document.write ("<h1>" + "Subtract from " + num1 + " to " + num2 + " is " + subtract + "</h1>");
...
// document.write ("<h1>" + "Multiplication of " + num1 + " or " + num2 + " is " + multiplication + "</h1>");
...
// document.write ("<h1>" + "Division of " + num1 + " and " + num2 + " is " + division + "</h1>");
...
// document.write ("<h1>" + "Modulus of " + num1 + " and " + num2 + " is " + modulus + "</h1>");


//                           Question # 03

// var num;
// document.write ("<h3>" + "Value after variable declaration is: " + num + "</h3>");

// num = 5;
// document.write ("<h3>" + "Initial value: " + num + "</h3>");

// num = ++num;
// document.write ("<h3>" + "Value after increment is: " + num + "</h3>");

// num = num + 7;
// document.write ("<h3>" + "Value after addition is: " + num + "</h3>");

// num = --num;
// document.write ("<h3>" + "Value after decrement is: " + num + "</h3>");

// num = num % 3;
// document.write ("<h3>" + "The remainder is : " + num + "</h3>");
...
// document.write ("<h3>" + "Total cost to buy 5 tickets to a movie is " + totalCost + " PKR");
...
// *************************Assignment_No_04_Chapter 9 to 11 and Chapter 12 to 13**************************
